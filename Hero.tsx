...
const StarRating = ({ rating, label }) => {
    ...
    return <div className="flex" role="img" aria-label={label}>{stars}</div>;
};


const Hero = () => {
    return (
        <section className="relative pt-24 pb-20 lg:pt-40 lg:pb-28 overflow-hidden hero-bg">
            <div className="container mx-auto px-6 text-center">
                <div className="max-w-3xl mx-auto">
                    <ScrollAnimator animation="fade-in-up">
                        <div className="flex items-stretch justify-center gap-4 sm:gap-6 bg-white/10 backdrop-blur-sm p-2 rounded-full mx-auto max-w-max">
                            {/* Google Rating */}
