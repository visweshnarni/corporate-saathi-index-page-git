        ...
        <header id="header" className={`bg-white dark:bg-brand-dark/95 backdrop-blur-sm fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isHeaderShadow ? 'shadow-md' : ''}`}>
            <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-4">
                    <a href="tel:+9102269622654" className="hidden sm:flex items-center space-x-2 text-slate-600 dark:text-slate-300 hover:text-brand-purple">
                        ...
                        <span className="text-sm font-medium">+91 022 6962 2654</span>
                    </a>
